    ...
    <View style={{display:'flex',flexDirection:'row',justifyContent:'space-between',alignItems:'center'}}>
        <View style={{display:'flex',flexDirection:'row',gap:15,alignItems:'center'}}>
            <View style={{backgroundColor:'#ce1484', width:40,height:40,borderRadius:99}}>
                <Text style={{textAlign:'center',fontSize:25,padding:3,fontWeight:'500',color:'#fff'}}>H</Text>
            </View>
            <Text style={{fontSize:20,fontWeight:'500',fontFamily:'outfit-bold'}}>Health Tech Nexus</Text>
        </View>
